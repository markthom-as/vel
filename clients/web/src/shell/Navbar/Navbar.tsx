      ...
      <div className={NAVBAR_INNER_CLASSNAME}>
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className={`truncate text-xs text-[var(--vel-color-muted)] ${uiFonts.mono}`}>{dateTime}</p>
          </div>
        </div>
        <div className="mx-auto hidden min-w-0 items-center gap-2 lg:flex">
          ...
          >
            ...
            <span className="inline-flex items-center justify-center text-[9px] uppercase leading-none tracking-[0.12em] [line-height:1]">{completedCount}/{taskTotal || completedCount}</span>
          </button>
          <button
            type="button"
