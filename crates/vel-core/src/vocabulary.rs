...
const GLOSSARY: &[GlossaryEntry] = &[
    ...
    GlossaryEntry {
        slug: "delegation-plan",
        term: "delegation plan",
        category: GlossaryCategory::Workflow,
        summary: "A planning artifact that captures proposed worker splits, ownership, or execution delegation without directly dispatching work.",
        aliases: &["delegation_plan", "delegate plan"],
        related_terms: &["execution plan", "spec draft", "artifact"],
        domain_kind: Some(DomainKind::DelegationPlan),
        dsl_selectors: &["goal", "latest"],
        dsl_operations: &["create", "inspect", "list", "explain"],
    ...
    GlossaryEntry {
        ...
        term: "delegate",
        category: GlossaryCategory::Command,
        summary: "DSL verb for creating a planned delegation-plan artifact intent.",
        aliases: &[],
        related_terms: &["delegation plan", "should"],
        domain_kind: None,
        dsl_selectors: &[],
        dsl_operations: &[],
        command_examples: &["vel command should delegate review queue cleanup"],
