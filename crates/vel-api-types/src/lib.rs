...
mod tests {
    use super::{
        ...
        AgentCapabilityGroupKindData, AgentInspectData, AgentProfileData, AppleBehaviorMetricData,
        AppleBehaviorSummaryData, AppleBehaviorSummaryScopeData, AppleClientSurfaceData,
