...
- **Now operator surface:** the main web shell now has a `Now` view that summarizes current context, explain reasons, upcoming calendar signals, and open commitments without dropping into a specific thread.
