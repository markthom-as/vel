...
Implemented same-day reflow/reconciliation baseline, not full planner closure.
...
The backend now fills that proposal from the current day's persisted commitments and calendar signals:
