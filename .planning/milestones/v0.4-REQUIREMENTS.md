# Milestone v0.4.x Requirements Archive

This archive preserves the previously active root requirements file for the `0.4.x` Now/UI conformance line.

The archived source is reproduced below without semantic changes.
