...
`0.5.7` was later deferred as future duplex voice work.

`0.5.8` is now the active follow-on planning-tooling milestone.
...
## Archived Active-Milestone Packet

`0.5.6` is closed and archived as the single-node MVP and polished web UI line.
