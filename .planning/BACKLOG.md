...
| `BL-007` | `B` | `proposed` | `agent-product` | `TBD later milestone` | Agent awareness of Vel data and operator-relevant tool access | `/home/jove/Downloads/Vel.csv` triage on 2026-03-19 | revisit after Phase 10/11 once the human daily loop and shell are stable | Keeps the CSV concern that agents still lack enough grounded awareness of Vel data and tools. This likely needs a dedicated product/runtime phase, not a UI cleanup slice. |
