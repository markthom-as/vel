...
key-files:
  created:
    [
      .planning/phases/56-conformance-verification-and-milestone-closeout/56-01-SUMMARY.md,
      .planning/phases/56-conformance-verification-and-milestone-closeout/56-VERIFICATION.md
    ]
  modified:
    [
      .planning/ROADMAP.md,
