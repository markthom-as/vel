...
- [ ] **Phase 46: Canonical Now contract, boundaries, and milestone lock** - Publish the durable Now surface contract and align product/architecture boundaries before implementation widens
- [ ] **Phase 47: Rust-owned Now core models and transport seam** - Build the shared Rust-owned task, day, thread, nudge, and context contracts that feed Now
...
|-------|--------------|--------|
| 46. Canonical Now contract, boundaries, and milestone lock | NOW-01 | Planned |
| 47. Rust-owned Now core models and transport seam | NOW-02, NOW-04, CORE-01, CORE-02, CORE-03, TASK-01, THREAD-01 | Planned |
| 48. Client mesh, linking, sync, and recovery authority | CORE-04, MESH-01, MESH-02, MESH-04, SYNC-01, SYNC-02 | Planned |
